...
def main():
    ...
    intervalo_inferior = int(input("Digite o valor inferior do intervalo (padrão -10): ") or -10)
    intervalo_superior = int(input("Digite o valor superior do intervalo (padrão 10): ") or 10)
